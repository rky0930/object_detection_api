...
def ssd_random_crop(image,
  ...
  def random_crop_selector(selected_result, index):
    ...
    with open("od.log", "w") as odf:
      odf.write("ssd_crop | min_object_covered:{}".format(min_object_covered))
      odf.write("ssd_crop | aspect_ratio_range:{}".format(aspect_ratio_range))
      odf.write("ssd_crop | area_range:{}".format(area_range))
      odf.write("ssd_crop | overlap_thresh:{}".format(overlap_thresh))
      odf.write("ssd_crop | random_coef:{}".format(random_coef))
