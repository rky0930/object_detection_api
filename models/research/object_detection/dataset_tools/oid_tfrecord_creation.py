...
def tf_example_from_annotations_data_frame(annotations_data_frame, label_map,
  ...
  label_list = filtered_data_frame_boxes.LabelName.map(lambda x: label_map[x]).tolist()
  #print('-----------------feature_map-----------------')
  #print(filtered_data_frame_boxes.LabelName.map(lambda x: label_map[x]).tolist())
  #print(filtered_data_frame_boxes)
  #print('---------------------------------------------')
